...
class PeluqueriaSubSpeciality
{
     ...
     * @JMS\Groups({"peluqueriaSubspeciality_index","peluqueria_speciality_index","peluqueriaSubspeciality_single","specialist_index"})
     */
    private $description;
     ...
     * @JMS\Groups({"peluqueriaSubspeciality_index","peluqueria_speciality_index","peluqueriaSubspeciality_single"})
     */
